...
class Scheme_API(APIView):
    ...
    def authorisation(self, data):
        ...
        account = models.Account.objects.get(card_id=data.get('card_id'))
    ...
    def presentment(self, data):
        ...
        customer = models.Users.objects.get(card_id=data.get('card_id'))
        ...
        User.user.total_balance = float(account.total_balance)
